...
#'
#'Aquesta funció ens serveix per escollir entre les taxes de creiement creades a partir de 4 temps o 3 temps. A més a més
#'té una part de filtrat perquè tenim els valors repetits per mantenir les pseudoabundàncies però per als següents 
#'passos no ens interessa.
#'
